...
export class BuiltyGridUtil {
    ...
    private static allColumns: Column[] = [
      ...
      { id: 'netWeight', name: 'Net Weight', field: 'netWeight', sortable: true, filterable: true,
      ...
      { id: 'destination', name: 'Destination', field: 'destination', filterable: true, minWidth: 120, type: FieldType.string},
